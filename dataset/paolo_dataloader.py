...
dataset_list = [mnist,mnist_train,mnist_test, mnist_m,mnist_m_train,mnist_m_test, svhn,svhn_train,svhn_test, synth, synth_train, synth_test, usps] + office_list

dataset_std = {mnist: (0.30280363, 0.30280363, 0.30280363),
               mnist_train: (0.30280363, 0.30280363, 0.30280363),
               mnist_test: (0.30280363, 0.30280363, 0.30280363),
               mnist_m: (0.2384788, 0.22375608, 0.24496263),
               mnist_m_train: (0.2384788, 0.22375608, 0.24496263),
               mnist_m_test: (0.2384788, 0.22375608, 0.24496263),
               svhn: (0.1951134, 0.19804622, 0.19481073),
               svhn_train: (0.1951134, 0.19804622, 0.19481073),
               svhn_test: (0.1951134, 0.19804622, 0.19481073),
               synth: (0.29410212, 0.2939651, 0.29404707),
               synth_train: (0.29410212, 0.2939651, 0.29404707),
               synth_test: (0.29410212, 0.2939651, 0.29404707),
               usps: (0.25887518, 0.25887518, 0.25887518)}

dataset_mean = {mnist: (0.13909429, 0.13909429, 0.13909429),
                mnist_train: (0.13909429, 0.13909429, 0.13909429),
                mnist_test: (0.13909429, 0.13909429, 0.13909429),
                mnist_m: (0.45920207, 0.46326601, 0.41085603),
                mnist_m_train: (0.45920207, 0.46326601, 0.41085603),
                mnist_m_test: (0.45920207, 0.46326601, 0.41085603),
                svhn: (0.43744073, 0.4437959, 0.4733686),
                svhn_train: (0.43744073, 0.4437959, 0.4733686),
                svhn_test: (0.43744073, 0.4437959, 0.4733686),
                synth: (0.46332872, 0.46316052, 0.46327512),
                synth_train: (0.46332872, 0.46316052, 0.46327512),
                synth_test: (0.46332872, 0.46316052, 0.46327512),
...
def get_dataset(dataset_name, image_size, mode="train", limit=None):
    ...
    if dataset_name == mnist:
        ...
        dataset = datasets.ImageFolder('usps', transform=img_transform)
    elif dataset_name == mnist_train:
        dataset = datasets.ImageFolder('mnist_train', transform=img_transform)
    elif dataset_name == mnist_test:
        dataset = datasets.ImageFolder('mnist_test', transform=img_transform)
    elif dataset_name == mnist_m_train:
        dataset = datasets.ImageFolder('mnist_m_train', transform=img_transform)
    elif dataset_name == mnist_m_test:
        dataset = datasets.ImageFolder('mnist_m_test', transform=img_transform)
    elif dataset_name == svhn_train:
        dataset = datasets.ImageFolder('svhn_train', transform=img_transform)
    elif dataset_name == svhn_test:
        dataset = datasets.ImageFolder('svhn_test', transform=img_transform)
    elif dataset_name == synth_train:
        dataset = datasets.ImageFolder('synth_train', transform=img_transform)
    elif dataset_name == synth_test:
        dataset = datasets.ImageFolder('synth_test', transform=img_transform)
